...
-- Adjust graphics settings to lowest quality
...
if _G.Settings["Low Water Graphics"] or (_G.Settings.Other and _G.Settings.Other["Low Water Graphics"]) then
    UserSettings.GameSettings:InGameSetGlobal("WaterReflectance", 0)
    UserSettings.GameSettings:InGameSetGlobal("WaterWaveSize", 0)
    UserSettings.GameSettings:InGameSetGlobal("WaterWaveSpeed", 0)
    UserSettings.GameSettings:InGameSetGlobal("WaterTransparency", 0)
    UserSettings.GameSettings:InGameSetGlobal("Decoration", false)
end
